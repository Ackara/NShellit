...
namespace Acklann.Poshley.Generators
{
    public class PSModuleGenerator : IShellWrapper
    {
        public PSModuleGenerator()
        {
            ...
            _packageDirectory = Path.Combine(Path.GetTempPath(), nameof(Poshley), "powershell");
        }
        ...
        public void GeneratePackage(IEnumerable<CommandInfo> commandList, string executable)
        {
            ...
            _packageDirectory = Path.Combine(workingDirectory, "generated", nameof(Poshley), AppInfo.Product);
